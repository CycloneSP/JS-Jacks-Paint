function configureListeners() {
    let images = [
        document.getElementById('pn1'),
        document.getElementById('pn2'),
        document.getElementById('pn3'),
        document.getElementById('pn4'),
        document.getElementById('pn5'),
        document.getElementById('pn6'),
        document.getElementById('pn7'),
        document.getElementById('pn8'),
        document.getElementById('pn9') // select img elements  
    ]
